  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="item.imgUrl" width="82px" />
          </li>
          <li>
            <p style="width: 400px">
              {{ item.skuName }}
    ...
    <div class="trade">
      <div class="price">
        应付金额:<span>¥{{ goodsSumPrice }}.00</span>
      </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['addressInfo', 'detailArrayList']),
    ...mapState({
      tradeList: (state) => state.Trade.tradeList,
      orderId: (state) => state.Pay.orderNumber
    }),
    // 计算商品的数量
    goodsNum() {
      return this.detailArrayList.length || 0
    },
    // 计算商品总价格
    goodsSumPrice() {
      let sum = 0
