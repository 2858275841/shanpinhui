...
.toolbar {
  ...
  .but {
    ...
    left: -29px;
    &.list {
      background-image: url(@/assets/images/Search/list.png);
      background-repeat: no-repeat;
      background-size: cover;
    }
    &.pull-wrap {
      background-image: url(@/assets/images/Search/cross.png);
      background-repeat: no-repeat;
      background-size: cover;
    }
  }
  .toolist {
    ...
    .pull {
      ...
      z-index: 66;
      .vip {
        background-image: url(@/assets/images/Search/toolbars.png);
